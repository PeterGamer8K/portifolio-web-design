  ...
  return (
    <div className="flex items-center justify-center" style={{}}>
      <div className="flex flex-col justify-center items-center laptop:gap-8 tablet:gap-4">
        <h3 className="laptop:text-h3 tablet:text-h3-tablet text-h3-phone font-thin font-josefin text-transparent bg-clip-text bg-gradient-to-r bg-brandGradient text-center mt-4">
          Hey, I'm Robert Fox
        </h3>
        ...
        <div className="flex flex-col justify-center items-center gap-24">
          <p className="text-paragraph-tablet font-montserrat max-w-[672px] text-center text-black-75 phone:text-paragraph-tablet">
